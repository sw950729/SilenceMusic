...
public class StatusBarUtil {
    ...
    public static boolean canTransparentStatuesBar() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT;
    }

    public static boolean transparentStatusBarWithToolbar(Activity activity, View toolbar) {
        boolean isTransparent = setTransparentStatusBar(activity);
        if (isTransparent) {
